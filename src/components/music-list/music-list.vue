  ...
  <div class="music-list">
    ...
    <div class="bg-image" :style="bgStyle" ref="bgImage">
      <div class="play-wrapper">
        <div class="play" v-show="song.length>0" ref="playButton">
          <i class="icon-play">
          </i>
    ...
    <scroll @scroll="scroll" :probe-type="probeType"  :listenScroll="listenScroll" :data="song" class="list" ref="list">
      <div class="song-list-wrapper">
        <song-list :songs="song" @select="selectItem"></song-list>
      </div>
